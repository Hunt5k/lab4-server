...
int main(int argc , char *argv[])
{
	...
	if (socket_desc == -1)
	{
		printf("create socket tidak dpt dibuat");
	}
	...
	if(new_socket == -1)
	{
		printf("Error dlm temporary socket creation");
		exit(1);
	}
